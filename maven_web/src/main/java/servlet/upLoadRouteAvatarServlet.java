...
public class upLoadRouteAvatarServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            //得到上传文件的保存目录。
            String realPath = this.getServletContext().getRealPath("/route_avatar");//  ./route_avatar
            ...
            for(FileItem item:items){
                ...
                if(item.isFormField()){
                    ...
                    map.put("route_avatar","../route_avatar/"+email+formatDate+fileName);
