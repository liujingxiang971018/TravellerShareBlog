...
public class upLoadFileServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            //得到上传文件的保存目录。
            String realPath = this.getServletContext().getRealPath("/user_avatar");//  ./user_avatar
            ...
            for(FileItem item:items){
                ...
                if(item.isFormField()){
                    ...
                    String filePath = realPath+"\\"+email+fileName;
                    ...
                    user.setUser_avatar("../user_avatar/"+email+fileName);
